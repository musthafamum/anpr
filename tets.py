...
# Reading Image
img = cv2.imread("/home/musthafa/Pictures/E4AE6974-0764-4BBB-A358-069028308347.jpg")
...
# Creating a Named window to display image
#v2.imshow("Gray Converted Image",img_gray)
# Display Image
...
##for c in contours:
 ...
 ##approx = cv2.approxPolyDP(c, 0.2 * peri, True)  # Approximating with 6% error
 ##print approx
